...
const App = () => {
  ...
  const [tasks, setTasks] = useState([
    { id: 0, phase: 1, title: 'Update Software', desc: 'Settings > Software update. Ensure OS, Play Store, and Galaxy Store apps are fully updated before proceeding.', completed: false },
    ...
    { id: 14, phase: 3, title: 'Unplug Alert Routine', desc: 'Modes & Routines > Routines tab > +. If: Add what will trigger... > Battery > Charging Status > Not Charging. Then: Add what this routine will do > Messages > Send message to primary.', completed: false, requiresSim: true },
    { id: 15, phase: 3, title: 'Movement Trigger Routine', desc: 'Modes & Routines > Routines tab > +. If: Add what will trigger... > Place > Leaving [Home]. Then: Add what this routine will do > Power Saving (ON) + Messages > Send message ("Moving").', completed: false, requiresSim: true }
  ]);
  ...
  const downloadExcel = () => {
    ...
    a.setAttribute('download', `s25_anti_theft_log_${simMode}.csv`);

...
const App = () => {
  const [tasks, setTasks] = useState([
    ...
    { id: 12, phase: 2, title: 'Google Find My Device (App)', desc: 'Install "Google Find My Device" APP. Sign in with dedicated account. App Settings > Notifications > Turn OFF. Location > Allow all the time.', completed: false },
